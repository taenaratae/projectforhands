...
void modify() {
    ...
    nodes[19 - 1].index = 94;
    nodes[20 - 1].index = 96;
    nodes[21 - 1].index = 100;
    nodes[22 - 1].index = 102;
    nodes[23 - 1].index = 104;
    nodes[24 - 1].index = 105;
    nodes[25 - 1].index = 106;
}
...
void showpath()
{
    if (shortest == 1) { printf("[Time To Arrive : %d min]", accumulated_gscore_HOSA); }
    if (shortest == 11) { printf("[Time To Arrive : %d min]", accumulated_gscore_HOSB); }
    if (shortest == 25) { printf("[Time To Arrive : %d min]", accumulated_gscore_HOSC); }
    printf("\n[Path : ");
    if(shortest == HOSA) {
